...
def create_db(conexion=connect_db()):
...
def insert_data(nombre, apellido, telefono, mail, conexion=connect_db()):
...
def update_data(nom_buscado,nombre, apellido, telefono, mail,conexion=connect_db()):
...
def delete_data(nom_buscado, conexion=connect_db()):
...
def get_all_data(conexion=connect_db()):
